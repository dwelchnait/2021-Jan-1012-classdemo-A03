...
namespace HighLowGame
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //any local variable within a method is "alive" only as long as the
                    ...
                    case "a":
                        {
                            ...
                            //why 
                            //   ensures that you hava spread of 3 possible (lower 4, upper 6)
                            //   ensures that the player did not entry the high number then
        ...
        //it is a skeleton setup for the requried method
        ...
        static string DisplayMenu()
        {
            ...
            //methods that do not return a value are also know as subroutines
        ...
        static int InputNumeric(string prompt)
        {
            ...
            //   and the loop condition tests to see if the boolean indicates
