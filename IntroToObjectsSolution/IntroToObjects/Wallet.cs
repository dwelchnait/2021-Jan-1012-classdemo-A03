...
namespace IntroToObjects
{
    ...
    public class Wallet
    {
        ...
        //      b) if you have to do ANY programing before returning the private data member
        //              to the other user
        //      c) if you have to do ANY programing before assigning the incoming data to
        ...
        //  when to use:
        //      if there is NO additional processing needed for the data coming in or going
        //          out.
        //  NOTE: when you use auto implemented properties you DO NOT create your OWN private
        //          data member
        //        instead, the system, ON YOUR BEHAVE, will create a storage area for the
        //          the data, will put the value in this area for you, will retreive the
        //          data for you.
        ...
        //IF, you HAVE/WANT to have multiple constructors, then YOU are resposible for
        ...
        public Wallet()
        {
            //it there is no code within the constructor, the variables
            ...
            //
            // a) your could use the property (instructoor's perference)
            ...
            //    WARNING! if you property does any logic against the value
        ...
        public Wallet(int cashbills, int cashcoins, string driverlicense,
                        string bankcard, string gascard, string visacard)
        {
            CashBills = cashbills;
            CashCoins = cashcoins;
