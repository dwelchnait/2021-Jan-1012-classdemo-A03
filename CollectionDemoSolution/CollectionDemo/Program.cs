    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                WriteLine($"\n\nTotal wall area {wallSurfaceArea} Total opening area" +
                    $" {openingArea} giving a net surface area to paint the color" +
                    $" of {myRoom.Color} of {wallSurfaceArea - openingArea} in the" +
                    $" room {myRoom.Name}\n\n");
            }
            catch(Exception ex)
            {
        ...
        static List<Wall> InputWallsForRoom()
        {
            ...
            do
            {
                ...
                //Step2 collect data and load the instance
        ...
        static void InputOpeningsForRoom(List<Opening> openings)
        {
            ...
            do
            {
                ...
                if (GetNonEmptyString("Do you have another opening, Y or N.").ToUpper().Equals("N"))
                {
                    finished = true;
                }
            } while (!finished);
