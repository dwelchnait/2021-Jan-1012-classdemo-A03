...
namespace ArraySamples
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //    //This means the the value actually passed to the method is
            //    //  NOT a copy of the physical data BUT a copy of the address
        ...
        static int GetName(string[] NameLocal, int logicalSizeLocal)
        {
            ...
            //logicalSizeLocal is playing the role to the next avaiable array
            //  element for storage, so "acting" as an index
            NameLocal[logicalSizeLocal] = Console.ReadLine();
            logicalSizeLocal++;
            return logicalSizeLocal;
        }
        static void Roll(int[] die3FacePointer, string[] dieFaceNamePointer,
                        Random rnd)
        {
            ...
            //  where the actual phyiscal data was copied and sent to the method 
            //  parameter
            ...
            //  to at the address, changes the physical data.
            ...
            //  method will present in the array at the calling statement.
